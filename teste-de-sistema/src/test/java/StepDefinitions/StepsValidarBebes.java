...
public class StepsValidarBebes {
		...
		WebDriver driver;
		MainPageObject paginaPrincipal;
		ValidarBebesPageObject paginaValidarBebes;
		...
		public void before() {
			...
			ValidarBebesPageObject validarBebesPageObject = new ValidarBebesPageObject(driver);
		}
